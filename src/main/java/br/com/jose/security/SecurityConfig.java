    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
            	    ...
            	    .requestMatchers("/", "/*.html", "/*.js", "/favicon.ico", "/Pessoa/**").permitAll()
            	  
            	     
            	    // ⬇️ NOVA REGRA: Libera o endpoint do controlador para fazer o upload físico sem exigir Token
            	    .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/midia/upload").permitAll()
